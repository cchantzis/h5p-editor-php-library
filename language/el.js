H5PEditor.language.core = {
  ...
  uploadSuccess: ':title μεταφορτώθηκε με επιτυχία!',
  ...
  contentTypeSectionAll: 'Όλοι οι τύποι περιεχομένου',
  ...
  contentTypeInstallSuccess: 'Ο τύπος περιεχομένου :contentType εγκαταστάθηκε με επιτυχία!',
  contentTypeUpdateSuccess: 'Ο τύπος περιεχομένου :contentType ενημερώθηκε με επιτυχία!',
  contentTypeInstallError: 'Ο τύπος περιεχομένου :contentType δεν ήταν δυνατόν να εγκατασταθεί. Επικοινωνήστε με τον διαχειριστή σας.',
  ...
  noResultsFoundDesc: 'Δεν υπάρχει τύπος περιεχομένου που να ταιριάζει στα κριτήρια αναζήτησης.',
  ...
  errorCommunicatingHubTitle: 'Δεν είναι η δυνατή η επικοινωνία με τον διανομέα/κόμβο.',
  ...
  noContentTypesAvailable: 'Δεν υπάρχουν διαθέσιμοι τύποι περιεχομένου',
  noContentTypesAvailableDesc: 'Ο ιστότοπός σας έχει δυσκολίες σύνδεσης με το H5P.org και εμφάνισης των διαθέσιμων τύπων περιεχομένου.',
  contentTypeCacheOutdated: 'Η λίστα με τους τύπους περιεχομένου είναι παρωχημένη',
  contentTypeCacheOutdatedDesc: 'Ο ιστότοπός σας έχει δυσκολίες σύνδεσης με το H5P.org για να ελέγξει για ενημερώσεις τύπου περιεχομένου. Ενδέχεται να μην μπορείτε να ενημερώσετε ή να εγκαταστήσετε νέους τύπους περιεχομένου.',
